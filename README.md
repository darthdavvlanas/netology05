...
Для исправления проблемы с портами нужно будет поправить файл /var/lib/docker/containers/<ID>/hostconfig.json

## Задача 4

![Задача-4](./console-3.png)
...
![Задача-5](./console-5.png)

![Задача-5](./console-6.png)
